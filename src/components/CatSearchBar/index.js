...
export default class CatSearchBar extends Component {
  ...
  render() {
    ...
    return (
      <View className={catSearchBarCls}>
        {
          isLink ?
          <View className="cat-search__icon-box" onClick={this.clickSearchBox}>
            <CatIcon
              type="icon-search"
              onClickEvent={this.handleClickIcon}
            />
            <View className="cat-search-placeholder">{placeholder}</View>
          </View>
          :
          <View className="cat-search__input-container">
            <View className="cat-search__input-box">
              <CatIcon type="icon-search" />
              <Input
                onInput={this.onInput}
                value={this.state.value}
                className="cat-search_input"
                placeholder={placeholder}
              />
              {
                this.state.value &&
                <CatIcon
                  onClickEvent={this.onEmpty}
                  type="icon-close"
                />
              }
            </View>
